...
class Arrow {
    ...
    run() {
        ...
        this.call(null, p, () => {}, err => {
          if (err instanceof Error) {
            //TODO: err.prepareStackTrace
          }
          throw err;
        });
        return p;
...
module.exports = {
  _setTypecheck: _setTypecheck,
  Arrow: Arrow,
  TaggedValue, TaggedValue,
  Progress: Progress,
  LiftedArrow: LiftedArrow,
  ElemArrow: ElemArrow,
  SimpleAsyncArrow: SimpleAsyncArrow,
  SimpleConfigBasedAsyncArrow: SimpleConfigBasedAsyncArrow,
  AjaxArrow: AjaxArrow,
  QueryArrow: QueryArrow,
  EventArrow: EventArrow,
  DynamicDelayArrow: DynamicDelayArrow,
  ...
  NoEmitCombinator: NoEmitCombinator,
  SeqCombinator: SeqCombinator,
  AllCombinator: AllCombinator,
  AnyCombinator: AnyCombinator,
  TryCombinator: TryCombinator,
  ProxyArrow: ProxyArrow,
  Type: Type,
  ParamType: ParamType,
  TopType: TopType,
  NamedType: NamedType,
